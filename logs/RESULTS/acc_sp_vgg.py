...
if __name__ == '__main__':
    ...
    ax.set_title("VGG-16 (CIFAR10)", **label_font, pad = 20)
    plt.ylabel("Test Accuracy (%)", **label_font, labelpad = 15)
    plt.xlabel("Sparsity (%)", **label_font, labelpad = 12)


    ax.set_xticks([sparsity_plots[0],] + sparsity_plots[4::6])
    ax.set_xticklabels([format_func(100 - val) for val in [sparsities[0],] + sparsities[4::6]], fontsize = 11)
