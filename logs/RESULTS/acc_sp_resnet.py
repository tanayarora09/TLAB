...
if __name__ == '__main__':
    ...
    concrete_names = {"loss": "Task Loss", "deltaloss": "Change in Loss", "gradnorm": "Gradient Norm", "kldlogit": "Parent Logit KLD", "msefeature": "Parent Feature MSE", "gradmatch": "Parent Gradient MSE"}
