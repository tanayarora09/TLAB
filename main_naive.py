...
def parse_args():
    ...
    parser.add_argument('--type', type=str, default='none', choices = ['none', 'magnitude', 'random'],
                        help="Type of Naive Sparsification to perform (default: none).")
    ...
    parser.add_argument('--sparsities', nargs='*', type=float, default=None,
                        help='Optional list of density percentages. If not provided, no sparsification is performed.')
...
if __name__ == "__main__":
    ...
    for exp in range(num_exp):
        ...
        print("--------------------------------------------------------------") 
        main(naive.main, exp_name + f"_{exp}", main_kwargs)