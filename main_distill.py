...
def parse_args():
    ...
    parser.add_argument('--parent', type=str, default='vgg16', choices = ['resnet20', 'vgg16', 'resnet50'],
                        help="Parent Model Architecture to Use.")
    parser.add_argument('--alpha', type=float, default=0.9,                        
                        help="Alpha value for distillation (weight towards distillation loss).")
    parser.add_argument('--temperature', type=float, default=5,                        
                        help="Temperature value for distillation.")
...
if __name__ == "__main__":
    ...
    from experiments import distill
    ...
    for exp in range(num_exp):
        ...
        print("--------------------------------------------------------------") 
        main(distill.main, exp_name + f"_{exp}", main_kwargs)