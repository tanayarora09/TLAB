...
class DataHandle:
    ...
    def get_loaders(self, *args, **kwargs):
        return self.module.get_loaders(*args, **kwargs)

    def get_partial_train_loader(self, *args, **kwargs):
        return self.module.get_partial_train_loader(*args, **kwargs)

    def get_sp_loaders(self, *args, **kwargs):
        return self.module.get_sp_loaders(*args, **kwargs)
